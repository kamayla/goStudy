...
//			ListTasksFunc: func(ctx context.Context, db *sqlx.DB) (entity.Tasks, error) {
...
func (mock *TaskListerMock) ListTasks(ctx context.Context, db *sqlx.DB) (entity.Tasks, error) {
